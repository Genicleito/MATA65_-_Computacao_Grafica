...
function init() {
    ...
    //camera2.lookAt(new THREE.Vector3(Math.randon, 0, -10));
...
//console.log("Tipo da camera: " + tipoCamera);
    switch(tipoCamera){
        ...
        case 2:
            ...
            break;
        case 3:
            var xCamera3 = groupTorus.getWorldPosition().x * 4;
            var yCamera3 = groupTorus.getWorldPosition().y * 4;
            var zCamera3 = groupTorus.getWorldPosition().z * 4;

            //console.log(xCamera3 + " " + yCamera3 + " " + zCamera3);
            camera2.position.set(xCamera3, yCamera3, zCamera3);
